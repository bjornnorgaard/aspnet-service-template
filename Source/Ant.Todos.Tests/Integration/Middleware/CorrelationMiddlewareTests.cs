...
namespace Ant.Todos.Tests.Integration.Middleware
{
    public class CorrelationMiddlewareTests : IntegrationTestBase
    {
        ...
        [Fact]
        public async void ShouldReturnHeaderWithCorrelationId_WhenNoCorrelationIdIsProvided()
        {
            // Arrange
        ...
        [Fact]
        public async void ShouldReturnHeaderWithTheSameCorrelationId_WhenCorrelationIdIsProvided()
        {
            // Arrange
